...
class Pinjam extends CI_Controller
{
    ...
    public function pinjamAct()
    {
        ...
        $this->db->query("UPDATE buku, booking_detail SET buku.dipinjam=buku.dipinjam+1, buku.dibooking=buku.dibooking-1 WHERE buku.id=booking_detail.id_buku");
    ...
    public function ubahStatus()
    {
        ...
        $this->db->query("UPDATE buku, detail_pinjam SET buku.dipinjam=buku.dipinjam-1, buku.stok=buku.stok+1 WHERE detail_pinjam.no_pinjam='$no_pinjam' AND buku.id=detail_pinjam.id_buku");
